<?php if (!defined('THINK_PATH')) exit();?><ul id="setGroup" class="easyui-tree" data-options="url:'<?php echo U("Core/setGroup");?>',method:'post',animate:true,checkbox:true,lines:true,queryParams:{id:<?php echo ($id); ?>}"></ul>
<form id="setGroupForm" action="<?php echo U('Core/setGroup');?>" method="post">
