<?php if (!defined('THINK_PATH')) exit();?><form id="addUser" action="<?php echo U('User/addUser');?>" method="post">
	...
	<table cellspacing="6" width="100%">
		...
		<tr>
			<td>所属部门：</td>
			<td><input class="easyui-combobox" data-options="valueField: 'id',required:true,textField: 'title',url: '<?php echo U('Base/listBranch');?>'"  name="branch_id" style="width:170px" /></td>
			<td>工作职务：</td>
			<td><input class="easyui-combobox" data-options="valueField: 'id',required:true,textField: 'title',url: '<?php echo U('Base/listJob');?>'"  name="job_id" style="width:170px" /></td>
		</tr>
		<tr>
			<td>用户状态：</td>
			<td>
		...
		<tr>
			<td>所属角色：</td>
			<td><input class="easyui-combobox" data-options="valueField: 'id',required:true,textField: 'title',multiple:true,url: '<?php echo U('Base/listGroup');?>'"  name="groups[][uid]" style="width:170px" /></td>
        </tr>
		<tr>
			<td>手机号码：</td>
