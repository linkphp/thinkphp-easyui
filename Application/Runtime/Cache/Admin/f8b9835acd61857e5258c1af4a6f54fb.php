...
window.Core_Panel = {
	...
	order: function(){
		...
		$.post("<?php echo U('Core/sortPanel');?>",$(".sort-input-Panel").serialize(),function(data){
	...
	edit: function(id){
		...
		$($.Oa.dialog_1).dialog({
			...
			height: '480',
			iconCls: 'icon-edit',
			href: '<?php echo U("Core/editPanel/");?>/id/'+id,
			modal: true
		});
	},
	...
	delete: function(id){
		...
		$.Oa.confirm('$.Oa.delData("'+id+'","<?php echo U("Core/delPanel");?>")')
	}
}
</script>
<script>
