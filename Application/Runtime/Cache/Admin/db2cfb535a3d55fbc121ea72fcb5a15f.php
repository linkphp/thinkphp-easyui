...
<div id="Core_LoginLog_Search" style="padding:5px;height:auto">
	<form id="Core_LoginLog_Search_Form">
		...
		<a href="javascript:;" onclick="Core_LoginLog.search()" class="easyui-linkbutton" iconCls
="icons-table-table">搜索</a>
		<a href="javascript:;" onclick="Core_LoginLog.delete()" class="easyui-linkbutton" iconCls="icons-table-table_delete"
>删除上月数据</a>
	</form>
</div>
...
window.Core_LoginLog = {
	...
	//删除上月数据
	delete: function(){
		$.Oa.confirm('$.Oa.delData("lastMonth","<?php echo U("Core/delLoginLog");?>")')
	}
}
</script>
<script>
