<?php if (!defined('THINK_PATH')) exit();?><form id="editBranch" action="<?php echo U('Branch/editBranch');?>" method="post">
	<input type="hidden" name="editBranch" value="editBranch" />
	<input type="hidden" name="id" value="<?php echo ($Branch["id"]); ?>" />
	<table cellspacing="6" width="100%">
		<tr>
			<td width="60">上级部门：</td>
			<td><input class="easyui-combotree" data-options="url:'<?php echo U('Base/treeListBranch');?>'" name="branch_id" value="<?php echo ($Branch["branch_id"]); ?>" style="width:230px;height:24px" /></td>
		</tr>
		<tr>
			<td>部门名称：</td>
